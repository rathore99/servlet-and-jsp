...
<form method="post" action="/employees-jsp/" enctype="multipart/form-data" style="margin-bottom:2em;">
    <input type="hidden" name="photoAction" value="update">
    <label>Employee ID:<br><input name="id" required style="width:100%"></label><br><br>
    <label>New Photo:<br><input type="file" name="photo" accept="image/*" required></label><br><br>
    <button type="submit" style="width:100%">Update Photo</button>
</form>
